  ...
  return (
    <section className="our_mission margin_navbar">
      <div className="container py-3">
        <h1>Our Mission</h1>
        <h3>Welcome to “Aya Sir G”</h3>
        <p>
          At “Aya Sir G,” we are committed to creating opportunities for
        ...
        <p>
          To bridge this gap, we launched “Aya Sir G”—a comprehensive platform
        ...
        <p>
          ...
          “rizq” (sustenance) reaches them with dignity.
        </p>
        <p>
          We consider this platform a form of Sadaqah Jariyah (continuous
          charity). If you know anyone in your circle who could benefit from
